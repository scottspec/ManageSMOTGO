...
(function () {
    ...
    _app._numericTypeRegex = /^(Byte|Currency|Decimal|Double|Int16|Int32|Int64|Single|SByte|UInt16|UInt32|UInt64)$/;
    ...
    _app.execute = function (args) {
        if (!args)
            args = {};
        var from = args.from || args.in || (_touch && !args.controller ? _touch.dataView() : null),
            fromField;

<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Welcome.ascx.vb" Inherits="Controls_Welcome"  %>
...
<div data-app-role="page" data-theme="a" data-app-toolbar="false" data-activator="Button|^SignInHeader^Instructions^SignInHeader^" data-activator-description="^SignInInstruction^Sign in to access the protected site content.^SignInInstruction^">
